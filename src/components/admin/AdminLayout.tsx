...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    localStorage.removeItem('jpt_admin_token');
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        <div className="flex items-center justify-between p-3 sm:p-4 border-b">
          <h2 className="text-xl sm:text-2xl font-bold text-primary">Admin Panel</h2>
        ...
        <div className="absolute bottom-0 w-full p-3 sm:p-4 border-t">
          <button
            ...
            className="flex items-center w-full px-3 sm:px-4 py-2 text-sm sm:text-base text-gray-700 hover:bg-red-500 hover:text-white"
          >
